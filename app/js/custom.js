$(document).ready(function(){
  ...
  //services-tabs
  $('.services-page_tabs-list').on('click', 'li:not(.active)', function() {
    $(this).addClass('active').siblings().removeClass('active').closest('.services-page_tabs').find('.services-page_tabs-content-item').removeClass('active').eq($(this).index()).addClass('active');
  });
